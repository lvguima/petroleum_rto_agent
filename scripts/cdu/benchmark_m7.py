...
DEFAULT_JSON_PATH = (
    _PROJECT_ROOT / "reports" / "cdu" / "m7_performance_baseline_v0.1.0.json"
)
DEFAULT_MARKDOWN_PATH = (
    _PROJECT_ROOT / "reports" / "cdu" / "M7_PERFORMANCE_BASELINE.md"
)
...
def build_markdown(document: Mapping[str, object], json_name: str) -> str:
    ...
    lines = [
        ...
        "",
        (
            "> 本报告由 `scripts/cdu/benchmark_m7.py` 从统一运行入口生成；"
