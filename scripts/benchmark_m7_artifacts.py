...
DEFAULT_JSON_PATH = _PROJECT_ROOT / "reports" / "modeling" / "m7_artifact_io_baseline_v0.1.0.json"
DEFAULT_MARKDOWN_PATH = _PROJECT_ROOT / "reports" / "modeling" / "M7_ARTIFACT_IO_BASELINE.md"
...
def build_markdown(document: Mapping[str, object], json_name: str) -> str:
    ...
    lines = [
        ...
        "",
        (
            "> 本报告由 `scripts/benchmark_m7_artifacts.py` 从固定 M3/M4 "
