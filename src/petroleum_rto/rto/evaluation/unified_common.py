"""Stage-neutral invariants shared by unified paired evaluators."""
...
from ..compilation.unified import assert_unified_compiled_pair
...
def validate_pair_bundles(
    ...
    assert_unified_compiled_pair(pair, problem, catalog)
