...
from ..capabilities.models import UnifiedCapabilityBundle
...
class PublishabilityAssessor:
    """Apply only explicit post-selection bindings from the unified system policy."""
...
class UnifiedFinalSelector:
    ...
    def _static_terminal_status(
        ...
        failure = UnifiedFinalSelector._system_failure(evaluations, prefix="static")
