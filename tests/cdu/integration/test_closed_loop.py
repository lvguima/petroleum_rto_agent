...
def m4_inputs(repo_root: Path) -> M4Inputs:
    return (
        load_model_config(repo_root / "configs/cdu/models/cdu_mini_v0.1.0.json"),
        load_case_config(repo_root / "configs/cdu/cases/case_20260604.json"),
        load_component_catalog(repo_root / "configs/cdu/models/components_v0.1.0.json"),
        load_control_config(repo_root / "configs/cdu/controllers/cdu_pi_v0.1.0.json"),
        load_closed_loop_scenario(
