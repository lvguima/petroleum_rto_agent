...
_ANALYSIS_BASIS_FINGERPRINT = "4c12146b6fb14cb033b0e05f64e68093f28087482f55128aed5aa56c37dfffed"
_PIPELINE_FINGERPRINT = "9e7bbda6a4f534008d847c49a42b2ee6526fb7132a5ca5db52a112ccf56941b7"
_MANIFEST_SHA256 = "948f400bf265855aa7a3c928307f6486660f12cbbada6f031c52544ed71e562b"
_MANIFEST_FINGERPRINT = "01c9cd02442e62da12f7263ce881dc566fdb25a721b0174ee4955544c5b124b1"
_ARTIFACT_SHA256 = {
...
_OBJECT_FINGERPRINTS = {
    "calibrated_model_object": ("49c04b222ab817ca2b27922171c832d562adcd55e80cda480c94b3142e0d2473"),
    "effective_case_object": ("6687e0637c0cfbef46f6020b52751058325363f2e175ced59b3ba4469658585e"),
...
def test_load_m6_basis_reconstructs_the_source_closed_effective_inputs(
    ...
    assert m6_basis.derived_parameter_set_version == "cdu-parameters-m5-case20260604-v0.1.0"
    ...
    assert m6_basis.model.equipment["desalter"]["wash_water_ratio"] == pytest.approx(
        0.04654072620215898
    )
...
def test_m5_parameter_tampering_is_rejected_even_with_rehashed_artifacts(
    ...
    for relative_path in artifact_paths.values():
        source = resolve_cdu_repository_path(repo_root, relative_path)
        target = resolve_cdu_repository_path(tmp_path, relative_path)
        target.parent.mkdir(parents=True, exist_ok=True)
        shutil.copyfile(source, target)

    parameter_path = resolve_cdu_repository_path(tmp_path, artifact_paths["calibrated_parameters"])
    ...
    manifest_path = resolve_cdu_repository_path(tmp_path, artifact_paths["artifact_manifest"])
    ...
    manifest_artifacts["calibrated_parameters"]["sha256"] = file_sha256(parameter_path)
