...
原M7基础候选的正式性能证据分别保存在[M7 执行性能基线](../../../reports/cdu/M7_PERFORMANCE_BASELINE.md)
和[M7 Artifact I/O 基线](../../../reports/cdu/M7_ARTIFACT_IO_BASELINE.md)。前者对 M2/M3/M4/M6
...
历史签署时的仓库内持久化副本路径为
`dist/m7-2-final/petroleum_rto_cdu_model-0.1.0-py3-none-any.whl`、
`dist/m7-2-final/petroleum_rto_cdu_model-0.1.0.tar.gz`及
`dist/m7-2-final/SHA256SUMS.txt`。当前工作树没有该目录；`dist/`根目录、`dist/m7-final/`和
